...
function getEndpoints(deviceAddress, endpoints) {
  ...
  var e = endpoints.addEndpoint("2", "Detección de humo (Sin usar)", endpointType.genericSensor);
  e.variableTypeId = 1408;
  
  var e = endpoints.addEndpoint("3", "Detección", endpointType.genericSensor);
  e.variableTypeId = 1408;
}
