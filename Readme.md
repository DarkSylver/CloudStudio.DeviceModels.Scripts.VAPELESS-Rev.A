...
# Configuration Script – VAPELESS - Rev. A

This **Configuration** script is designed for the **VAPELESS** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – VAPELESS Rev. A

Este script de **Configuration** está diseñado para el modelo **VAPELESS** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
